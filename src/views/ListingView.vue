...
<template>
    <div class="container listing-container my-4 pb-4">
        ...
        <div class="author-block">
            <img :src="'/OceanLet/assets/' + listingInfo[listing].authorLogo" :alt="listingInfo[listing].author" class="author-image mx-auto"/>
